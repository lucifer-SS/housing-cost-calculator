...
describe('ExtraExpenses', () => {
  it('renders all existing event rows', () => {
    render(<ExtraExpenses events={defaultEvents} onAdd={vi.fn()} onRemove={vi.fn()} onChange={vi.fn()} enabled onToggle={vi.fn()} />)
  ...
  it('calls onAdd when the Add expense button is clicked', () => {
    const onAdd = vi.fn()
    render(<ExtraExpenses events={[]} onAdd={onAdd} onRemove={vi.fn()} onChange={vi.fn()} enabled onToggle={vi.fn()} />)
  ...
  it('calls onRemove with the correct id when a remove button is clicked', () => {
    ...
    render(<ExtraExpenses events={defaultEvents} onAdd={vi.fn()} onRemove={onRemove} onChange={vi.fn()} enabled onToggle={vi.fn()} />)
  ...
  it('calls onChange when a label input changes', () => {
    ...
    render(<ExtraExpenses events={defaultEvents} onAdd={vi.fn()} onRemove={vi.fn()} onChange={onChange} enabled onToggle={vi.fn()} />)
  ...
  it('renders empty state with just the add button', () => {
    render(<ExtraExpenses events={[]} onAdd={vi.fn()} onRemove={vi.fn()} onChange={vi.fn()} enabled onToggle={vi.fn()} />)
